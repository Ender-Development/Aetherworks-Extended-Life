...
public class AWBlocks implements ILifecycleListener
{
    ...
    public static void onBlockRegistry(RegistryEvent.Register<Block> event)
    {
        Block[] toRegister = new Block[]{
                ...
                new PrismSupport(),
                new Prism(),
                new BlockFluidClassic(AWFluids.FLUID_IMPURE_AETHERIUM_GAS, Material.LAVA).setRegistryName(AWConsts.blockImpureAetheriumGas).setTranslationKey("aw.impureAetheriumGas"),
                new BlockFluidClassic(AWFluids.FLUID_AETHERIUM_GAS, Material.LAVA).setRegistryName(AWConsts.blockAetheriumGas).setTranslationKey("aw.aetheriumGas"),
                new Structure(),
                new AetherBlock(),
                new Component(),
                new HeatDial()
