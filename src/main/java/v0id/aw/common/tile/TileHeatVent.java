...
public class TileHeatVent extends TileEntity implements IForgePart
{
    ...
    {
        if (this.world.getBlockState(this.getPos()).getBlock() instanceof Component && forge.getHeatCapability().getHeatStored() > 100 && !world.isBlockPowered(this.getPos()) && world.getRedstonePowerFromNeighbors(this.getPos()) <= 0)
        {
