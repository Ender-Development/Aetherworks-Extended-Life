...
public class AWResearch implements ILifecycleListener {
    ...
    {
        Vec2i[] randomPositions = new Vec2i[]{new Vec2i(0, 6), new Vec2i(1, 3), new Vec2i(0, 0), new Vec2i(4, 3), new Vec2i(6, 7), new Vec2i(9, 0), new Vec2i(12, 3), new Vec2i(9, 5), new Vec2i(9, 7), new Vec2i(11, 7), new Vec2i(5, 5), new Vec2i(4, 7), new Vec2i(12, 5), new Vec2i(2, 4)};
        ...
        aether_collector = new ResearchBase("aether_collector", new ItemStack(AWBlocks.AETHER_PRISM_CONTROLLER_MATRIX), categoryAetherworks.popGoodLocation()).addAncestor(aetherium_ore);
        purifying_aetherium = new ResearchBase("purifying_aetherium", new ItemStack(BlockRegister.MIXER), categoryAetherworks.popGoodLocation()).addAncestor(aether_collector);
        ...
        ResearchBase aetherium_tools_page = new ResearchFakePage(aetherium_tools, 6,4).addAncestor(forge);
        ...
        ResearchBase toolSwitch = makeCategorySwitch(subCategoryAetheriumTools, 12, 5, new ItemStack(AWItems.RESOURCE, 1, 7), 0,1).addAncestor(anvil);

        categoryAetherworks.addPrerequisite(ResearchManager.dawnstone);
        categoryAetherworks.addResearch(aetherium_ore);
        categoryAetherworks.addResearch(aether_collector);
