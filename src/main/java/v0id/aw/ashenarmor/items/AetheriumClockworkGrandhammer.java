...
public class AetheriumClockworkGrandhammer extends ItemTool implements IModeledItem, IEmberChargedTool {

    public static ToolMaterial materialAetheriumGrandhammer = EnumHelper.addToolMaterial(AWConsts.MODID + ":aetheriumClockworkGrandhammer",
            ConfigTool.TOOL.AETHERIUM_CLOCKWORK_GRANDHAMMER.harvestLevel,
            ConfigTool.TOOL.AETHERIUM_CLOCKWORK_GRANDHAMMER.durability,
            ConfigTool.TOOL.AETHERIUM_CLOCKWORK_GRANDHAMMER.efficiency,
            ConfigTool.TOOL.AETHERIUM_CLOCKWORK_GRANDHAMMER.damage,
            ConfigTool.TOOL.AETHERIUM_CLOCKWORK_GRANDHAMMER.enchantability
    );

    public AetheriumClockworkGrandhammer(String name, boolean addToTab) {
        super(materialAetheriumGrandhammer, Sets.newHashSet(new Block[]{Blocks.STONE}));
        setTranslationKey(name);
        setRegistryName(AWConsts.MODID + ":" + name);
        if (addToTab) {
