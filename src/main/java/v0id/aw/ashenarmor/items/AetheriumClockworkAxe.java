...
public class AetheriumClockworkAxe extends ItemTool implements IModeledItem, IEmberChargedTool {

    public static ToolMaterial materialClockworkAxe = EnumHelper.addToolMaterial(AWConsts.MODID + ":aetheriumClockworkAxe",
            ConfigTool.TOOL.AETHERIUM_CLOCKWORK_AXE.harvestLevel,
            ConfigTool.TOOL.AETHERIUM_CLOCKWORK_AXE.durability,
            ConfigTool.TOOL.AETHERIUM_CLOCKWORK_AXE.efficiency,
            ConfigTool.TOOL.AETHERIUM_CLOCKWORK_AXE.damage,
            ConfigTool.TOOL.AETHERIUM_CLOCKWORK_AXE.enchantability
    );

    public AetheriumClockworkAxe(String name, boolean addToTab) {
