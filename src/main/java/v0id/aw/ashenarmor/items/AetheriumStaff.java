...
import v0id.aw.api.ProjectileAether;
import v0id.aw.common.config.ConfigTool;

import java.awt.*;

public class AetheriumStaff extends AetheriumBase implements IProjectileWeapon {
    public static double EMBER_COST = ConfigTool.AETHERIUM_STAFF.cost;
    public static int COOLDOWN = ConfigTool.AETHERIUM_STAFF.cooldown;
    public static double MAX_CHARGE = ConfigTool.AETHERIUM_STAFF.charge;
    public static float DAMAGE = ConfigTool.AETHERIUM_STAFF.damage;
    public static float SIZE = ConfigTool.AETHERIUM_STAFF.size;
    public static float AOE_SIZE = ConfigTool.AETHERIUM_STAFF.aoe;
    public static int LIFETIME = ConfigTool.AETHERIUM_STAFF.lifetime;

    public static boolean soundPlaying = false;

    public AetheriumStaff() {
        super("staff_aetherium", true);
    ...
    public void onPlayerStoppedUsing(ItemStack stack, World world, EntityLivingBase entity, int timeLeft) {
        if (!world.isRemote) {
            ...
            ProjectileAether fireball = new ProjectileAether(entity, launchPos, entity.getLookVec().scale(0.85), size, lifetime, effect);
            //color
    ...
    public void onUsingTick(ItemStack stack, EntityLivingBase player, int count) {
        ...
        ItemVisualEvent event = new ItemVisualEvent(player, Misc.handToSlot(player.getActiveHand()), stack, new Color(16, 208, 255), fullCharge ? SoundManager.CINDER_STAFF_LOOP : null, 1.0f, 1.0f, "charge");
