...
public class AetheriumClockworkPickaxe extends ItemTool implements IModeledItem, IEmberChargedTool {
    ...
    public static ToolMaterial materialClockworkAxe = EnumHelper.addToolMaterial(AWConsts.MODID + ":aetheriumClockworkPickaxe",
            ConfigTool.TOOL.AETHERIUM_CLOCKWORK_PICKAXE.harvestLevel,
            ConfigTool.TOOL.AETHERIUM_CLOCKWORK_PICKAXE.durability,
            ConfigTool.TOOL.AETHERIUM_CLOCKWORK_PICKAXE.efficiency,
            ConfigTool.TOOL.AETHERIUM_CLOCKWORK_PICKAXE.damage,
            ConfigTool.TOOL.AETHERIUM_CLOCKWORK_PICKAXE.enchantability
    );

    public AetheriumClockworkPickaxe(String name, boolean addToTab) {
