...
public class ProjectileAetherRay implements IProjectilePreset {
    ...
    Color color = new Color(16,208,255);

    public ProjectileAetherRay(Entity shooter, Vec3d start, Vec3d end, boolean pierceEntities, IProjectileEffect effect) {
        this.pos = start;
